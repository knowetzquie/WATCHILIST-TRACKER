...
export default function App() {
  ...
  const [listGenre, setListGenre] = useState("all");
    ...
    return visibleItems.filter((item) => {
      ...
      const matchesGenre =
        ...
        (item.genre || "")
          ...
          .includes(listGenre.toLowerCase());
      return matchesQuery && matchesGenre;
    });
  }, [listGenre, listQuery, visibleItems]);
  ...
  return (
    <div className="page">
      ...
      <main className="content">
        ...
        {page === "watchlist" && (
          <>
            ...
            {loading ? (
              ...
              <PosterGrid items={searchedItems} onOpenDetails={setDetailItem} />
            )}
          </>
        )}
        ...
        {page === "discover" && (
          <DiscoverPage items={items} onAdd={handleAdd} />
        )}

        {page === "collections" && <CollectionsPage items={items} />}

        {page === "diary" && (
          <DiaryPage items={items} onOpenDetails={setDetailItem} />
        )}
